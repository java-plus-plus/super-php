...
class Image extends SuperPHPElement {
     public DOMNode $node;
      ...
      * @param String|null alt	This attribute defines an alternative text description of the image.
      ...
      * @param String|null src	The image URL. This attribute is mandatory for the `<img>` element. On browsers supporting `srcset`, `src` is treated like a candidate image with a pixel density descriptor `1x` unless an image with this pixel density descriptor is already defined in `srcset,` or unless `srcset` contains '`w`' descriptors.
      * @param String|null srcset	A list of one or more strings separated by commas indicating a set of possible image sources for the user agent to use. Each string is composed of:
...
The user agent selects any one of the available sources at its discretion. This provides them with significant leeway to tailor their selection based on things like user preferences or bandwidth conditions. See our [Responsive images](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images) tutorial for an example.
      * @param String|null crossorigin	This enumerated attribute indicates if the fetching of the related image must be done using CORS or not. [CORS-enabled images](https://developer.mozilla.org/en-US/docs/CORS_Enabled_Image) can be reused in the [`<canvas>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/canvas "Use the HTML <canvas> element with either the canvas scripting API or the WebGL API to draw graphics and animations.") element without being "[tainted](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image#What_is_a_tainted_canvas)." The allowed values are:
      * @param String|null usemap	The partial URL (starting with '#') of an [image map](https://developer.mozilla.org/en-US/docs/HTML/Element/map) associated with the element.

      **Note:** You cannot use this attribute if the `<img>` element is a descendant of an [`<a>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a "The HTML <a> element (or anchor element) creates a hyperlink to other web pages, files, locations within the same page, email addresses, or any other URL.") or [`<button>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button "The HTML <button> element represents a clickable button, which can be used in forms or anywhere in a document that needs simple, standard button functionality.") element.
      * @param String|null ismap	This Boolean attribute indicates that the image is part of a server-side map. If so, the precise coordinates of a click are sent to the server.

      **Note:** This attribute is allowed only if the `<img>` element is a descendant of an [`<a>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a "The HTML <a> element (or anchor element) creates a hyperlink to other web pages, files, locations within the same page, email addresses, or any other URL.") element with a valid [`href`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#attr-href) attribute.
      * @param String|null width	The intrinsic width of the image in pixels.
      * @param String|null height	The intrinsic height of the image in pixels.
      * @param String|null decoding	undefined
      * @param String|null importance	undefined
      * @param String|null intrinsicsize	undefined
     ...
     function __construct(
          ...
          parent::__construct();
          $this->node = self::$dom->createElement("img");
          ...
          if ($ismap) $this->node->setAttribute("ismap", $ismap);
          if ($width) $this->node->setAttribute("width", $width);
          if ($height) $this->node->setAttribute("height", $height);
          if ($decoding) $this->node->setAttribute("decoding", $decoding);
          if ($importance) $this->node->setAttribute("importance", $importance);
          if ($intrinsicsize) $this->node->setAttribute("intrinsicsize", $intrinsicsize);
