...
class Area extends SuperPHPElement {
     public DOMNode $node;
      ...
      * @param String|null coords	undefined
      * @param String|null shape	undefined
      * @param String|null href	undefined
      * @param String|null target	undefined
      * @param String|null download	undefined
      * @param String|null ping	undefined
      * @param String|null rel	undefined
      * @param String|null hreflang	undefined
     ...
     function __construct(
          ...
          parent::__construct();
          $this->node = self::$dom->createElement("area");
          ...
          if ($coords) $this->node->setAttribute("coords", $coords);
          if ($shape) $this->node->setAttribute("shape", $shape);
