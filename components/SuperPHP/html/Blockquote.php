...
class Blockquote extends SuperPHPElement {
     public DOMNode $node;
      ...
      * @param String|null cite	A URL that designates a source document or message for the information quoted. This attribute is intended to point to information explaining the context or the reference for the quote.
      * 
      * * Global attributes:
     ...
     function __construct(
          ...
          parent::__construct();
          $this->node = self::$dom->createElement("blockquote");
