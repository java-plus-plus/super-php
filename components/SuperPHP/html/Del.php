...
class Del extends SuperPHPElement {
     public DOMNode $node;
     ...
     function __construct(
          ...
          parent::__construct();
          $this->node = self::$dom->createElement("del");
