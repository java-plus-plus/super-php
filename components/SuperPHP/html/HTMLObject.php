...
class HTMLObject extends SuperPHPElement {
     public DOMNode $node;
      ...
      * @param String|null data	The address of the resource as a valid URL. At least one of **data** and **type** must be defined.
      * @param String|null $type	The [content type](https://developer.mozilla.org/en-US/docs/Glossary/Content_type) of the resource specified by **data**. At least one of **data** and **type** must be defined.
      * @param String|null $typemustmatch	This Boolean attribute indicates if the **type** attribute and the actual [content type](https://developer.mozilla.org/en-US/docs/Glossary/Content_type) of the resource must match to be used.
      * @param String|null $name	The name of valid browsing context (HTML5), or the name of the control (HTML 4).
      * @param String|null usemap	A hash-name reference to a [`<map>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/map "The HTML <map> element is used with <area> elements to define an image map (a clickable link area).") element; that is a '#' followed by the value of a [`name`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/map#attr-name) of a map element.
      * @param String|null $form	The form element, if any, that the object element is associated with (its _form owner_). The value of the attribute must be an ID of a [`<form>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form "The HTML <form> element represents a document section that contains interactive controls for submitting information to a web server.") element in the same document.
      * @param String|null width	The width of the display resource, in [CSS pixels](https://drafts.csswg.org/css-values/#px). -- (Absolute values only. [NO percentages](https://html.spec.whatwg.org/multipage/embedded-content.html#dimension-attributes))
      * @param String|null height	The height of the displayed resource, in [CSS pixels](https://drafts.csswg.org/css-values/#px). -- (Absolute values only. [NO percentages](https://html.spec.whatwg.org/multipage/embedded-content.html#dimension-attributes))
      * @param String|null archive	undefined
      * @param String|null border	undefined
      * @param String[]|null $classid	undefined
      * @param String|null codebase	undefined
      * @param String|null codetype	undefined
      * @param String|null declare	undefined
      * @param String|null standby	undefined
      * 
      * * Global attributes:
     ...
     function __construct(
          ...
          parent::__construct();
          $this->node = self::$dom->createElement("object");
          ...
          // Element-specific attributes
          if ($data) $this->node->setAttribute("data", $data);
          if ($type) $this->node->setAttribute("type", $type);
          if ($typemustmatch) $this->node->setAttribute("typemustmatch", $typemustmatch);
          if ($name) $this->node->setAttribute("name", $name);
          if ($usemap) $this->node->setAttribute("usemap", $usemap);
          ...
          if ($archive) $this->node->setAttribute("archive", $archive);
          if ($border) $this->node->setAttribute("border", $border);
          if ($classid) $this->node->setAttribute("classid", $classid);
          if ($codebase) $this->node->setAttribute("codebase", $codebase);
          if ($codetype) $this->node->setAttribute("codetype", $codetype);
          if ($declare) $this->node->setAttribute("declare", $declare);
          if ($standby) $this->node->setAttribute("standby", $standby);
