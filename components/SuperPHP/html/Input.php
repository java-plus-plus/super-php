...
class Input extends SuperPHPElement {
     public DOMNode $node;
      ...
      * @param String|null alt	undefined
      * @param String|null autocomplete	undefined
      * @param String|null autofocus	undefined
      * @param String|null checked	undefined
      * @param String|null dirname	undefined
      * @param String|null disabled	undefined
      * @param String|null form	undefined
      * @param String|null formaction	undefined
      * @param String|null formenctype	undefined
      * @param String|null formmethod	undefined
      * @param String|null formnovalidate	undefined
      * @param String|null formtarget	undefined
      * @param String|null height	undefined
      * @param String|null list	undefined
      * @param String|null max	undefined
      * @param String|null maxlength	undefined
      * @param String|null min	undefined
      * @param String|null minlength	undefined
      * @param String|null multiple	undefined
      * @param String|null name	undefined
      * @param String|null pattern	undefined
      * @param String|null placeholder	undefined
      * @param String|null readonly	undefined
      * @param String|null required	undefined
      * @param String|null size	undefined
      * @param String|null src	undefined
      * @param String|null step	undefined
      * @param String|null type	undefined
      * @param String|null value	undefined
     ...
     function __construct(
          ...
          $this->node = self::$dom->createElement("input");
          ...
          if ($checked) $this->node->setAttribute("checked", $checked);
          ...
          if ($list) $this->node->setAttribute("list", $list);
          ...
          if ($pattern) $this->node->setAttribute("pattern", $pattern);
          ...
          if ($step) $this->node->setAttribute("step", $step);
