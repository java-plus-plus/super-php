...
class TextButton extends Material2Core {
     ...
     * @param SuperPHPElement|null $icon
     * 
     ...
     * @version 1.0.0 - 14 September 2022
     */
    function __construct(
        public ?SuperPHPElement $child = null,
        public ?array $children = null,
        public ?SuperPHPElement $icon = null,
        ...
        $this->node = (new Button(
            class: ["mdc-button", $icon ? "mdc-button--icon-leading" : null],
            children: [
                $icon,
                new Div(class: ["mdc-button__ripple"]),
                new Span(
            ...
            customAttributes: [
                new CustomAttr("data-mdc-auto-init", "MDCRipple"),
            ],
            autofocus: $autofocus,
            disabled: $disabled,
            form: $form,
...
class OutlinedButton extends Material2Core {
    ...
    function __construct(
        ...
        $this->node = (new Button(
            class: ["mdc-button", $icon ? "mdc-button--icon-leading" : null, "mdc-button--outlined"],
            children: [
                $icon,
                new Div(class: ["mdc-button__ripple"]),
                new Span(
...
class ContainedButton extends Material2Core {
    ...
    function __construct(
        ...
        $this->node = (new Button(
            class: ["mdc-button", $icon ? "mdc-button--icon-leading" : null, "mdc-button--raised"],
            children: [
                $icon,
                new Div(class: ["mdc-button__ripple"]),
                new Span(
